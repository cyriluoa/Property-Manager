...
class DeniedPaymentsFragment : Fragment() {
    ...
    companion object {
        ...
        ): DeniedPaymentsFragment {
            return DeniedPaymentsFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvDenied.adapter = adapter
        binding.rvDenied.layoutManager = LinearLayoutManager(requireContext())

        sharedViewModel.deniedPayments.observe(viewLifecycleOwner) {
        ...
        if (sharedViewModel.deniedPayments.value == null)
